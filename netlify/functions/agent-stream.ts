      ...
      try {
        ...
        for (let round = 0; round < MAX_ROUNDS; round++) {
          ...
          const friendlyName: Record<string, string> = {
            ...
            get_transactions:             'Checking finance records…',
            get_activities:              'Loading contact timeline…',
            get_contractors:             'Looking up contractors…',
            get_sms_queue:               'Checking SMS queue…',
            get_agreements:              'Loading agreements…',
